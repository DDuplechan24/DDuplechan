...
var apple = {//need to do dot notation
  element,
  row,
  column, 
  direction,
...
function checkForNewDirection(event) {//doesn't work
 /* 
...
function handleKeyDown(event) {
  ...
  event.which = {// returns the keycode of the key that is pressed when the keydown event occurs
